...
- Research mode: ideation, data collection, pain extraction, opportunity generation, landing page brief, or full sprint.
...
Never invent quotes or cite "many users" unless source volume supports it. If there are only a few comments, say the evidence is thin and frame findings as hypotheses.

## Ranking

Score pain points and opportunities from 1-5:

| Factor | Meaning |
|---|---|
| Pain intensity | Emotional/financial/time stakes are strong and repeated. |
| Buyer clarity | The person with the pain and ability to act/pay is obvious. |
| Current spend | Users already pay money, time, attention, or social cost. |
| Differentiation | There is a plausible wedge beyond "better app". |
| Reachability | The audience can be found manually in communities or direct channels. |
| Speed to validate | A manual test can prove demand in 1-2 weeks. |

Prefer a direct verdict over neutral hedging:

- **Strong**: painful, reachable, paid behavior exists, and a narrow wedge is clear.
